...
var backgroundColor = "#F8F8FF";
var borderColor = chroma(backgroundColor).darken(0.5);
var textColor = "#000000";
var bright = _objectSpread(_objectSpread({}, generateTheme({
  name: "light",
  ...
  textColor: [].concat(_toConsumableArray(chroma.scale([chroma(textColor).brighten(2), chroma(textColor).brighten(8)]).colors(8).slice(1).reverse()), [textColor], _toConsumableArray(chroma.scale([chroma(textColor).darken(0.5), chroma(textColor).darken(6)]).colors(8).slice(1)))
});

export { bright as default };
